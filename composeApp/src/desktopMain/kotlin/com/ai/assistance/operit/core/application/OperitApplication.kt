...
class OperitApplication : Application(), SingletonImageLoader.Factory, WorkConfiguration.Provider {
    ...
    override fun onCreate() {
        ...
        globalImageLoader = ImageLoader.Builder(PlatformContext.INSTANCE).build()
    }
